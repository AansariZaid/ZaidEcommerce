...
@ComponentScan({ "Niit.BackendSecuretronic" })
public class HibernateConfiguration {

	private final static String JDBC_URL = "jdbc:h2:tcp://localhost/~/SecDB";
    ...
    public SessionFactory sessionFactory(DataSource dataSource) {
        ...
        builder.scanPackages("Niit.BackendSecuretronic");
